...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='supplier',
            name='supplier_Type',
            field=models.ForeignKey(verbose_name=b'\xe4\xbe\x9b\xe5\xba\x94\xe5\x95\x86\xe7\xb1\xbb\xe5\x9e\x8b', to='polls.SupplierType'),
        ),
        migrations.AddField(
            model_name='decorationcontract',
            name='proj_type',
            field=models.ForeignKey(verbose_name=b'\xe9\xa1\xb9\xe7\x9b\xae\xe7\xb1\xbb\xe5\x88\xab', to='polls.SupplierType'),
        ),
        migrations.AddField(
            model_name='decorationcontract',
            name='project',
            field=models.ForeignKey(verbose_name=b'\xe9\xa1\xb9\xe7\x9b\xae\xe5\x90\x8d\xe7\xa7\xb0', to='polls.Project'),
        ),
        migrations.AddField(
            model_name='decorationcontract',
            name='supplier',
            field=models.ForeignKey(verbose_name=b'\xe4\xbe\x9b\xe5\xba\x94\xe5\x95\x86', to='polls.Supplier'),
        ),
    ]
